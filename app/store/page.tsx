    ...
    <>
      <Section className="text-center">
        <h1 className="font-heading text-4xl font-semibold text-ink md:text-5xl">
          Ch&rsquo;rps-branded NFC tags, ready to use.
        </h1>
        <p className="mx-auto mt-5 max-w-2xl text-lg text-muted">
          Ch&rsquo;rps tags are pre-provisioned and claimed to your company on
          setup — a tag not purchased through Ch&rsquo;rps simply won&rsquo;t
      ...
      <Section bg="bg-card" tightTop>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted">
            Already a Ch&rsquo;rps client and need to reorder? The same page
            works for that too.
          </p>
          <div className="mt-5">
